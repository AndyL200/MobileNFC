...

{
    public class Functions
    {
        ...
        public Functions(AppleWalletConfiguration appleWalletConfiguration)
        {
            _appleWalletConfiguration = appleWalletConfiguration;
        }
        public async Task<HttpResponseMessage> Default(string orderId, string eventId)
        {
            PassGeneratorRequest request = await GetPassRequest(orderId, eventId);
